...
function completeTask(e) {
    // Check if the clicked spot was an icon or a button containing the icon and complete the task if it is
    if (e.target.classList.contains("fa-check-circle") || e.target.classList.contains("btn--complete")) {
